...
import com.muravtech.merishiksha.onlineexam.models.QuestionAnswerStartExamModel;
import com.muravtech.merishiksha.onlineexam.utilities.CircularTextView;
import com.muravtech.merishiksha.onlineexam.utilities.CustomViewPager;
                   ...
                   // }
                    ...
                    for (int j = 0; j < mJsonArray.length(); j++) {
                      ...
                      //  model.setAnswer5(mObject.getString("option_e"));
                        ...
                        model.setAnswer6(mObject.getString("finalanswer"));
    ...
    public JSONArray makJsonObject()
        ...
        for (int i = 0; i < answerStartExamModelArrayList.size(); i++) {
            ...
            try {
                ...
                obj.put("finalanswer", answerStartExamModelArrayList.get(i).getAnswer6());
