...
import com.muravtech.merishiksha.onlineexam.models.FragmentSolutionModel;
import com.muravtech.merishiksha.onlineexam.models.ResultsFragmentModel;

import com.muravtech.merishiksha.onlineexam.utilities.CircularTextView;
import com.muravtech.merishiksha.onlineexam.utilities.CustomProgress;
import com.muravtech.merishiksha.onlineexam.utilities.ExceptionHandler;
import com.muravtech.merishiksha.onlineexam.utilities.MainPagerAdapter;
import com.muravtech.merishiksha.onlineexam.utilities.PicassoImageGetter;
import com.muravtech.merishiksha.onlineexam.utilities.SharedPrefData;
...
//            resultsFragmentModel.setMaxMarks(mJsonObjectResults.getString("maxMarks"));
            ...
            for (int l = 0; l < mJsonArrayAnalysis.length(); l++) {
                ...
                fragmentAnalysisModel.setSubject(mObject.getString("subject_name"));
                fragmentAnalysisModel.setTotalQuestion(mObject.getString("no_of_question"));
            ...
            for (int i = 0; i < resultSolutionsArray.length(); i++) {
                ...
                model.setCorrectanswer(mObject.getString("finalanswer"));
                model.setQuestiontype(mObject.getString("questiontype"));
             //   model.setDirection(mObject.getString("direction"));

                model.setQuestion(mObject.getString("question_name"));
                model.setAnswer1(mObject.getString("option_a"));
                model.setAnswer2(mObject.getString("option_b"));
                model.setAnswer3(mObject.getString("option_c"));
                model.setAnswer4(mObject.getString("option_d"));
               //model.setAnswer5(mObject.getString("option_e"));
...
//                        new PicassoImageGetter(question), null));
        ...
        Log.e("TAG", "answer1111111: "+model.getAnswer1() );
...
//        finish();
        ...
        Intent intent = new Intent(this, StudentDashBoardScreenActivity.class);
