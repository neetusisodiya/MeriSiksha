...
import com.muravtech.merishiksha.adapter.TeacherFriendListAdapter;
    ...
    private void getFriendList() {
       ...
       if(type.equalsIgnoreCase("student")) {
           call = APIClient.getClient().create(DKRInterface.class)
                   .getTeacherListForFriend(AppPreferences.getAccessId(),AppPreferences.getSchoolId(),preferences.getStringValue(AppPreferences.CLASS_ID), AppPreferences.getSectionId(),preferences.getStringValue(AppPreferences.Type));
       }else {
           call = APIClient.getClient().create(DKRInterface.class)
                   .getTeacherListForFriend(AppPreferences.getAccessId(),AppPreferences.getSchoolId(), "","",preferences.getStringValue(AppPreferences.Type));
       }
