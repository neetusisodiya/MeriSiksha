...
import com.muravtech.merishiksha.adapter.FriendListAdapter;
    ...
    private void getFriendList() {
        ...
        if(type.equalsIgnoreCase("student")) {
            call = APIClient.getClient().create(DKRInterface.class)
                    .getStudentListForFriend(AppPreferences.getAccessId(),AppPreferences.getSchoolId(), id,preferences.getStringValue(AppPreferences.Type));
        }else {
            call = APIClient.getClient().create(DKRInterface.class)
                    .getStudentListForFriend(AppPreferences.getAccessId(),AppPreferences.getSchoolId(), id,preferences.getStringValue(AppPreferences.Type));
        }
