package com.muravtech.merishiksha.utils;
...
public class AppPreferences {
    ...
    public static SharedPreferences mPrefsRwo;
    ...
    public AppPreferences(Context context) {
        ...
        mPrefsRwo = context.getSharedPreferences(SHARED_PREFERENCE_NAME, Context.MODE_PRIVATE);
    }
    ...
    public String getAccessToken() {
        return mPrefsRwo.getString(AppPreferences.ACCESS_TOKEN, "");
    }


    public static void setAccessToken(String accessToken) {
        SharedPreferences.Editor editor = mPrefsRwo.edit();
