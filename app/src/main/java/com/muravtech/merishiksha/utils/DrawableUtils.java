...
public final class DrawableUtils {
    ...
    public static Drawable getCircleDrawableWithText1(Context context, String string) {
        Drawable background = ContextCompat.getDrawable(context, R.drawable.btngreen);
        Drawable text = CalendarUtils.getDrawableText(context, string, null, android.R.color.white, 12);
