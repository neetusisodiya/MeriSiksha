...
import com.muravtech.merisiksha.Response.QuizWrapper;
import com.muravtech.merisiksha.Response.ResponseLoginGetIngo;
import com.muravtech.merisiksha.Response.SectionWiseList;
import com.muravtech.merisiksha.Response.SingleStudentAttadenceBean;
import com.muravtech.merisiksha.Response.StaffListDetailBean;
...
public interface DKRInterface {
    ...
    public Call<ResponseBody> checkUser(
    ...
    @FormUrlEncoded
    @POST("get-class")
    Call<ClassListBean> getClassList(@Field("id") String school_id);
