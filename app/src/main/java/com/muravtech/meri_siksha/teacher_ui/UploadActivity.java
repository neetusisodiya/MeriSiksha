    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.video_upload:
                type = "video";
                customDialog("Send Video Link","Enter video link","Upload link");
...
//                startActivityForResult(i, 1);
            ...
            case R.id.link:
                type = "link";
                customDialog("Send Link","Enter link","upload link");
                break;
            case R.id.doc_file:
                type = "document";
    ...
    private void customDialog(String et_title,String hint,String btnName) {
        ...
        EditText editText_link = (EditText) dialogView.findViewById(R.id.editText_link);
        ...
        title_txt.setText(et_title);
        buttonUpload.setText(btnName);
        editText_link.setHint(hint);
        ...
        buttonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(title.equalsIgnoreCase("")){
                    CommonUtils.showToast(UploadActivity.this, "Enter Title");
                }else
    ...
    private void uploadFile() {
        ...
        if (mediaPath != null) {
            ...
            call = getResponse.uploadLink(AppPreferences.getSchoolId(), AppPreferences.getAccessId(), type, "1", title,section_id, subject_id, link);
        }
