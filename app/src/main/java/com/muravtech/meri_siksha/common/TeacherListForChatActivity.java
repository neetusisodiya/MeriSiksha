    ...
    private void getFriendList() {
       ...
       if(type.equalsIgnoreCase("student")) {
           call = APIClient.getClient().create(DKRInterface.class)
                   .getTeacherListForFriend(AppPreferences.getAccessId(),AppPreferences.getSchoolId(), AppPreferences.getSectionId(),preferences.getStringValue(AppPreferences.Type));
       }else {
           call = APIClient.getClient().create(DKRInterface.class)
